...
export class Bat {
  ...
  public constructor(scene: THREE.Scene, world: CANNON.World, battingSide: BattingSide = "右打席") {
  ...
  public setBattingSide = (battingSide: BattingSide) => {
    this.battingSide = battingSide;
    this.reset();
  };
  ...
  private setAngle = (angleDegree: number) => {
